...
export class Landing implements OnInit {
  ...
  carouselCards: CarouselCard[] = [
    {
      ...
      imageSrc: '/images/sq_redis_engine.jpg',
      readTime: '4 MIN READ',
      tag: 'REDIS CACHE'
    },
    {
      ...
      imageSrc: '/images/sq_prereq_dag.jpg',
      readTime: '6 MIN READ',
    ...
    },
    {
      ...
      imageSrc: '/images/sq_triage_matrix.jpg',
      readTime: '5 MIN READ',
      tag: 'FAIRNESS MATRIX'
    },
    {
      ...
      imageSrc: '/images/sq_database_sync.jpg',
      readTime: '5 MIN READ',
      tag: '@SCHEDULED SYNC'
    },
    {
      ...
      imageSrc: '/images/sq_jwt_security.jpg',
      readTime: '3 MIN READ',
      tag: 'JWT RBAC'
    }
  ];
  ...
  editorialLead = {
    ...
    imageSrc: '/images/sq_clinical_research.jpg',
    readTime: '8 MIN READ'
  };
